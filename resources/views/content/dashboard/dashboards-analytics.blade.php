            ...
            <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                    <div class="card-body">
                        ...
                        <p class="mb-4">ยินดีต้อนรับเข้าสู่แดชบอร์ดของ <span class="fw-medium" style="color: orange">บริษัท อินเรียลเอสเตท จำกัด</span> <br>
                            สำหรับจัดการข้อมูลโพสประกาศ และข้อมูลผู้เข้าชมเว็บไซต์
                        </p>
                    </div>
                </div>
